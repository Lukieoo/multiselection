package com.anioncode.multiselection;
...
public class MultiAdapter extends RecyclerView.Adapter<MultiAdapter.MultiViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MultiViewHolder multiViewHolder, int position) {
      ...
      //  multiViewHolder.itemView.setBackgroundColor(Color.parseColor("#ddd"));
    }
    ...
    class MultiViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final Employee employee) {
            ...
            itemView.setBackgroundColor(employee.isChecked() ? Color.parseColor("#dddddd") : Color.parseColor("#ffffff"));
